...
<div class="content">
  <center>
    <form method="post" action="php/inscription.php">
      <p>
        <a id="id_exist">L'Identifiant existe deja</a></br>
      ...
      <a id="passerror">Mots de passe différents</a>
      <p>
        <label>Nom</label>
        </br>
      ...
      <input id="login" type="submit" value="Inscription"/>
    </form>
  </center>
</div>
<script type="text/javascript">
  psw1.addEventListener("input", function (e){
    pass_match();
  });
